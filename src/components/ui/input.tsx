  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-emerald-500/60 focus-visible:ring-emerald-500/20 focus-visible:ring-[3px] dark:focus-visible:border-emerald-400/60 dark:focus-visible:ring-emerald-400/15",
